...
Subject to the constraints \crefrange{eq:RealPowerBalanceNodej}{eq:modelEndsHere} given below:
\begin{align}
    ...
    { B^{t}_{j} } &\in { \left[ soc_{min}B_{R, j}, soc_{max}B_{R, j} \right] } \label{eq:modelEndsHere} &&
    % {} & {} \nonumber \label{eq:modelEndsHere}
\end{align}
