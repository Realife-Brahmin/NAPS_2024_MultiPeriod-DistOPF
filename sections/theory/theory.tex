...
\begin{table}[h!]
    ...
    $P_{DER\_Rated_j}$ & $\frac{1}{3} P_{L\_Rated_j}$ \\ \hline
    $S_{DER\_Rated_j}$ & $1.2 P_{DER\_Rated_j}$ \\ \hline
    $P_{B\_Rated_j}$ & $\frac{1}{3} P_{L\_Rated_j}$ \\ \hline
    $B_{Rated_j}$ & $T_{fullCharge} \times P_{B\_Rated_j}$ \\ \hline
