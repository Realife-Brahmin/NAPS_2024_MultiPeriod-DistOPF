...
\begin{enumerate}
    ...
    \item Detailed comparative analyses between traditional MPCOPF and the proposed MPDOPF are carried out using IEEE 123 bus test system and the benefits of the proposed approach are demonstrated. ACOPF feasibility validation is also performed by implementing the derived control signals into an OpenDSS simulation model of the test system.
\end{enumerate}
