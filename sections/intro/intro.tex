...
\begin{tabular}{|p{1.2cm}||p{0.2cm}||p{0.2cm}||p{0.2cm}||p{0.2cm}||p{0.2cm}||p{0.2cm}||p{2.5cm}|}   %{l *{8}{r}}
    ...
    \cite{Alizadeh, Usman}     & \checkmark     &  \checkmark         &       & \checkmark     & \checkmark      &    & Non-convex\\ \hline

    \cite{Wu}     & \checkmark     &  \checkmark         &       & \checkmark     & \checkmark      &    & Non-convex\\ \hline
