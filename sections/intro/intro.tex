...
\begin{enumerate}
    \item A multi-period non-convex OPF framework is proposed for a distribution network consisting of distributed DERs and batteries. The integer variables related to battery charging/discharging are avoided by adding a ''Battery Loss'' term with the objective function. The loss term will ensure the non-occurrence of simultaneous charging/discharging operations.
